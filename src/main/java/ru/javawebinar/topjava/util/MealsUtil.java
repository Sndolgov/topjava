...
public class MealsUtil {
    public static final List<Meal> MEALS = Arrays.asList(
            ...
            new Meal(2,LocalDateTime.of(2017, Month.MAY, 31, 10, 0), "Завтрак!", 1000),
            new Meal(2,LocalDateTime.of(2017, Month.MAY, 31, 13, 0), "Обед!", 500),
            new Meal(2,LocalDateTime.of(2017, Month.MAY, 31, 20, 0), "Ужин!", 510)
    );
